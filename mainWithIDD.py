...
def convertmat2mne(data):
    ...
    epochs = mne.make_fixed_length_epochs(data, duration=10, overlap=0)
...
patientsFeatures = calculate_features(idd_subject)
controlsFeatures = calculate_features(tdc_subject)
